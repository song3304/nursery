...
class Album extends Model 
{
    ...
    public function album_class()
    {
        return $this->hasOne('App\\AlbumClass', 'id', 'class_id');
    }
    //相册 与学生关系
    public function students()
    {
        return $this->belongsToMany('App\\User', 'album_student', 'aid', 'sid');
    }
    //相册与老师的关系
    public function teachers()
    {
        return $this->belongsToMany('App\\Teacher', 'album_teacher', 'aid', 'tid');
    }
